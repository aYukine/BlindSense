...
class StereoPerceptionNode(Node):
    def __init__(self):
        ...
        # Synchronize the topics based on exact timestamps
        ...
        self.get_logger().info("Unified Perception Engine Initialized. Waiting for image topics...")
    ...
    def process_stereo_frames(self, left_msg: Image, right_msg: Image):
        # Convert ROS Image messages back to numpy arrays
